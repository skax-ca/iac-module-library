...
## Priority Context
SSOT=이 repo. 엔진=OpenTofu(decisions.md 재제안 전 필독). 규약=conventions.md(이름포맷 AWS=Name태그/Azure=name인자, 노드풀명은 conventions 소유·약어카탈로그 아님). 네이밍=docs/naming/abbreviations/{aws,azure}.md. 모듈경로=modules/<provider>/<name>/. .tf규칙=.claude/rules/terraform.md. AWS4+Azure1(vnet), 전5모듈 nullable=false+태그컷 완료(2026-08-27). aks-cluster 설계 v4 승인 완료(ralplan, 2026-08-28), 실행(Step1-5, docs 4개+main커밋) 미착수 — .omc/plans/2026-08-28-azure-aks-cluster-design.md(gitignore 대상). 영구사실=project-memory.json.
