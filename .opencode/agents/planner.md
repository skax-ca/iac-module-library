...
2. 관련 설계 문서를 찾는다: 모듈 계약은 `docs/module-catalog.md`, 규약은 `docs/conventions.md`, 기각된 대안은 `docs/decisions.md`(재제안 전 필독). 네이밍 약어는 `docs/naming/abbreviations/aws.md`(AWS 약어 SSOT)에서만.
