...
## 작업 절차
1. 요청된 작업을 읽고, 어떤 모듈/문서가 영향을 받는지 파악한다 (repo 구조는 `AGENTS.md`·`README.md`·`docs/README.md`).
2. 관련 설계 문서를 찾는다: 모듈 계약은 `docs/05-modules.md`, 규약은 `docs/06-conventions.md`, 기각된 대안은 `docs/08-decisions.md`(재제안 전 필독). 네이밍 약어는 `docs/aws-naming-abbreviations.md`(SSOT)에서만.
