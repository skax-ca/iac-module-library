...
## 리뷰 기준
1. **repo 계약**: 모듈 계약(`docs/module-catalog.md`)·규약(`docs/conventions.md`)과의 일치. 설계 문서가 없는 코드는 최우선 지적 항목.
2. **네이밍**: `Name` 태그 포맷·약어가 `docs/naming/abbreviations/aws.md`(AWS 약어 SSOT)를 따르는지. 임의 약어 생성 금지.
