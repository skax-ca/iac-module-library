...
| 로컬에서 파기하려고 **실행 Role 신뢰에 사용자 추가** | 파기가 승인 게이트를 우회하게 된다. 파기 경로는 신뢰 경계 **안에** 낸다 — 워크플로 `action=destroy`([03-hub-lifecycle.md](03-hub-lifecycle.md) · [04-spoke-lifecycle.md](04-spoke-lifecycle.md)) |
